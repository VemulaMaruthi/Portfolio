...
function About () {
    return (
        <>
         <div className = "w-full h-full  mt-20 flex flex-col items-center">
            <div className = " flex flex-col items-center text-center gap-4  mt-5">
                ...
                <p className = "text-gray-500 text-2xl">Building scalable software with clean code and modern technologies.</p>
            </div>
         </div>
        <div className = "flex flex-col md:flex-row">
         <div className = "w-full md:w-[50vw]  mt-4 pl-2">
            <div className = " flex flex-col justify-center md:ml-16 my-10 gap-10">
         ...
         <div className = " flex sm:justify-center items-center flex-col gap-20 w-full md:w-[50vw] mt-4">
            <section className = "border-2 border-black mt-10 px-6 py-4 rounded-xl hover:text-blue-600 hover:border-blue-600 transition duration-300"> 
        ...
        />
            ...
            <section className = "border-2 border-black px-6 py-4 rounded-xl font-medium hover:text-blue-600 hover:border-blue-600 transition duration-300">6+ Technologies learned</section>
            <section className = "border-2 border-black px-6 py-4 rounded-xl mb-10 font-medium hover:text-blue-600 hover:border-blue-600 transition duration-300">over 5+ projects</section>
        </div>
        </div>
        </>
    )
