...
const Contacts = forwardRef((props, ref) => {
  ...
  const openLinkedin = () => {
    window.open("http://localhost:8080/linkedIn", "_blank");
  };

  const openGithub = () => {
    window.open("http://localhost:8080/gitHub", "_blank");
  };
    ...
    <>
      <div ref={ref} className="w-full h-full mt-20 flex flex-col items-center">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-2xl text-gray-500">Build Something Great Together</p>
